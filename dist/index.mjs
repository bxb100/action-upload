...
function which(tool, check) {
	return __awaiter$7(this, void 0, void 0, function* () {
		...
		if (check) {
			...
			if (!result) if (IS_WINDOWS$6) throw new Error(`Unable to locate executable file: ${tool}. Please verify either the file path exists or the file can be found within a directory specified by the PATH environment variable. Also verify the file has a valid extension for an executable file.`);
...
var ToolRunner = class extends events.EventEmitter {
	...
	_getCommandString(options, noPrefix) {
		...
		if (IS_WINDOWS$5) if (this._isCmdFile()) {
			cmd += toolPath;
	...
	*/
	exec() {
		return __awaiter$6(this, void 0, void 0, function* () {
			if (!isRooted(this.toolPath) && (this.toolPath.includes("/") || IS_WINDOWS$5 && this.toolPath.includes("\\"))) this.toolPath = path$2.resolve(process.cwd(), this.options.cwd || process.cwd(), this.toolPath);
...
//#endregion
//#region node_modules/opendal/generated.js
var require_generated = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	init_esm_shims();
	const { createRequire: createRequire$1 } = __require("node:module");
	require = createRequire$1(__filename);
	...
	function requireNative() {
		if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) try {
			...
			try {
				return __require("./opendal.android-arm64.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
				const binding = __require("@opendal/lib-android-arm64");
				const bindingPackageVersion = __require("@opendal/lib-android-arm64/package.json").version;
				if (bindingPackageVersion !== "0.49.2" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.49.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			}
			...
			try {
				return __require("./opendal.android-arm-eabi.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
				const binding = __require("@opendal/lib-android-arm-eabi");
				const bindingPackageVersion = __require("@opendal/lib-android-arm-eabi/package.json").version;
				if (bindingPackageVersion !== "0.49.2" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.49.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			...
			try {
				return __require("./opendal.win32-x64-msvc.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
				const binding = __require("@opendal/lib-win32-x64-msvc");
				const bindingPackageVersion = __require("@opendal/lib-win32-x64-msvc/package.json").version;
				if (bindingPackageVersion !== "0.49.2" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.49.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			...
			try {
				return __require("./opendal.win32-ia32-msvc.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
				const binding = __require("@opendal/lib-win32-ia32-msvc");
				const bindingPackageVersion = __require("@opendal/lib-win32-ia32-msvc/package.json").version;
				if (bindingPackageVersion !== "0.49.2" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.49.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			...
			try {
				return __require("./opendal.win32-arm64-msvc.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
				const binding = __require("@opendal/lib-win32-arm64-msvc");
				const bindingPackageVersion = __require("@opendal/lib-win32-arm64-msvc/package.json").version;
				if (bindingPackageVersion !== "0.49.2" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.49.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			...
			try {
				return __require("./opendal.darwin-universal.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
				const binding = __require("@opendal/lib-darwin-universal");
				const bindingPackageVersion = __require("@opendal/lib-darwin-universal/package.json").version;
				if (bindingPackageVersion !== "0.49.2" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.49.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			...
			if (process.arch === "x64") {
				try {
					return __require("./opendal.darwin-x64.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
					const binding = __require("@opendal/lib-darwin-x64");
					const bindingPackageVersion = __require("@opendal/lib-darwin-x64/package.json").version;
					if (bindingPackageVersion !== "0.49.2" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.49.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
					return binding;
				} catch (e) {
					loadErrors.push(e);
				...
				try {
					return __require("./opendal.darwin-arm64.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
					const binding = __require("@opendal/lib-darwin-arm64");
					const bindingPackageVersion = __require("@opendal/lib-darwin-arm64/package.json").version;
					if (bindingPackageVersion !== "0.49.2" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.49.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
					return binding;
				} catch (e) {
					loadErrors.push(e);
			...
			try {
				return __require("./opendal.freebsd-x64.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
				const binding = __require("@opendal/lib-freebsd-x64");
				const bindingPackageVersion = __require("@opendal/lib-freebsd-x64/package.json").version;
				if (bindingPackageVersion !== "0.49.2" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.49.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			...
			try {
				return __require("./opendal.freebsd-arm64.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
				const binding = __require("@opendal/lib-freebsd-arm64");
				const bindingPackageVersion = __require("@opendal/lib-freebsd-arm64/package.json").version;
				if (bindingPackageVersion !== "0.49.2" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.49.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			...
			try {
				return __require("./opendal.linux-x64-musl.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
				const binding = __require("@opendal/lib-linux-x64-musl");
				const bindingPackageVersion = __require("@opendal/lib-linux-x64-musl/package.json").version;
				if (bindingPackageVersion !== "0.49.2" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.49.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			...
			try {
				return __require("./opendal.linux-x64-gnu.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
				const binding = __require("@opendal/lib-linux-x64-gnu");
				const bindingPackageVersion = __require("@opendal/lib-linux-x64-gnu/package.json").version;
				if (bindingPackageVersion !== "0.49.2" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.49.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			...
			try {
				return __require("./opendal.linux-arm64-musl.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
				const binding = __require("@opendal/lib-linux-arm64-musl");
				const bindingPackageVersion = __require("@opendal/lib-linux-arm64-musl/package.json").version;
				if (bindingPackageVersion !== "0.49.2" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.49.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			...
			try {
				return __require("./opendal.linux-arm64-gnu.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
				const binding = __require("@opendal/lib-linux-arm64-gnu");
				const bindingPackageVersion = __require("@opendal/lib-linux-arm64-gnu/package.json").version;
				if (bindingPackageVersion !== "0.49.2" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.49.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			...
			try {
				return __require("./opendal.linux-arm-musleabihf.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
				const binding = __require("@opendal/lib-linux-arm-musleabihf");
				const bindingPackageVersion = __require("@opendal/lib-linux-arm-musleabihf/package.json").version;
				if (bindingPackageVersion !== "0.49.2" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.49.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			...
			try {
				return __require("./opendal.linux-arm-gnueabihf.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
				const binding = __require("@opendal/lib-linux-arm-gnueabihf");
				const bindingPackageVersion = __require("@opendal/lib-linux-arm-gnueabihf/package.json").version;
				if (bindingPackageVersion !== "0.49.2" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.49.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			...
			try {
				return __require("./opendal.linux-riscv64-musl.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
				const binding = __require("@opendal/lib-linux-riscv64-musl");
				const bindingPackageVersion = __require("@opendal/lib-linux-riscv64-musl/package.json").version;
				if (bindingPackageVersion !== "0.49.2" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.49.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			...
			try {
				return __require("./opendal.linux-riscv64-gnu.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
				const binding = __require("@opendal/lib-linux-riscv64-gnu");
				const bindingPackageVersion = __require("@opendal/lib-linux-riscv64-gnu/package.json").version;
				if (bindingPackageVersion !== "0.49.2" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.49.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			...
			try {
				return __require("./opendal.linux-ppc64-gnu.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
				const binding = __require("@opendal/lib-linux-ppc64-gnu");
				const bindingPackageVersion = __require("@opendal/lib-linux-ppc64-gnu/package.json").version;
				if (bindingPackageVersion !== "0.49.2" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.49.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			...
			try {
				return __require("./opendal.linux-s390x-gnu.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
				const binding = __require("@opendal/lib-linux-s390x-gnu");
				const bindingPackageVersion = __require("@opendal/lib-linux-s390x-gnu/package.json").version;
				if (bindingPackageVersion !== "0.49.2" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.49.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			...
			try {
				return __require("./opendal.openharmony-arm64.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
				const binding = __require("@opendal/lib-openharmony-arm64");
				const bindingPackageVersion = __require("@opendal/lib-openharmony-arm64/package.json").version;
				if (bindingPackageVersion !== "0.49.2" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.49.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			...
			try {
				return __require("./opendal.openharmony-x64.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
				const binding = __require("@opendal/lib-openharmony-x64");
				const bindingPackageVersion = __require("@opendal/lib-openharmony-x64/package.json").version;
				if (bindingPackageVersion !== "0.49.2" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.49.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
			...
			try {
				return __require("./opendal.openharmony-arm.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
				const binding = __require("@opendal/lib-openharmony-arm");
				const bindingPackageVersion = __require("@opendal/lib-openharmony-arm/package.json").version;
				if (bindingPackageVersion !== "0.49.2" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.49.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
				return binding;
			} catch (e) {
				loadErrors.push(e);
	...
	if (!nativeBinding || process.env.NAPI_RS_FORCE_WASI) {
		try {
			nativeBinding = __require("./opendal.wasi.cjs");
		} catch (err) {
			if (process.env.NAPI_RS_FORCE_WASI) loadErrors.push(err);
		}
		if (!nativeBinding) try {
			nativeBinding = __require("@opendal/lib-wasm32-wasi");
		} catch (err) {
			if (process.env.NAPI_RS_FORCE_WASI) loadErrors.push(err);
		}
	}
...
//#endregion
//#region node_modules/opendal/index.mjs
var opendal_exports = /* @__PURE__ */ __exportAll({
	default: () => opendal_default,
	layers: () => layers
});
var import_generated = /* @__PURE__ */ __toESM(require_generated(), 1);
__reExport(opendal_exports, /* @__PURE__ */ __toESM(require_generated(), 1));
var ReadStream = class extends Readable {
	...
	_read(size) {
		...
		this.reader.read(buf).then((s) => {
			if (s === 0n) this.push(null);
			else this.push(buf.subarray(0, Number(s)));
		}).catch((e) => {
			this.emit("error", e);
		});
	}
};
var BlockingReadStream = class extends Readable {
	constructor(reader, options) {
		super(options);
		this.reader = reader;
	}
...
var BlockingWriteStream = class extends Writable {
	constructor(writer, options) {
		super(options);
		this.writer = writer;
	}
...
const { Operator: Operator$1, RetryLayer: RetryLayer$1, ConcurrentLimitLayer, BlockingReader, Reader, BlockingWriter, Writer } = import_generated;
...
const layers = {
	RetryLayer: RetryLayer$1,
	ConcurrentLimitLayer
};
var opendal_default = import_generated;

//#endregion
//#region src/config.ts
function stripQuotes(value) {
	for (const q of ["\"", "'"]) if (value.startsWith(q) && value.endsWith(q)) return value.slice(1, -1);
	return value;
}
function parseKeyValueLines(lines) {
	return Object.fromEntries(lines.map((line) => line.trim()).filter((line) => line && !line.startsWith("#")).filter((line) => !line.startsWith("=") && !line.endsWith("=")).filter((line) => line.includes("=")).map((line) => stripQuotes(line)).map((line) => {
...
var Config = class {
	...
	flatten;
	constructor() {
		this.provider = getInput("provider", {
			required: true,
			trimWhitespace: true
		}).toLowerCase();
		this.options = parseKeyValueLines(getMultilineInput("provider_options", { required: false }));
		this.patterns = getMultilineInput("include", {
			required: true,
			trimWhitespace: true
		}).map(stripQuotes);
		this.flatten = getBooleanInput("flatten", { required: false });
	}
};
...
var import_minimatch = /* @__PURE__ */ __toESM(require_minimatch(), 1);
		...
		return __asyncGenerator(this, arguments, function* globGenerator_1() {
			...
			while (stack.length) {
				...
				if (stats.isDirectory()) {
					...
					const childItems = (yield __await(fs.promises.readdir(item.path))).map((x) => new SearchState(path$2.join(item.path, x), childLevel));
...
function splitPatterns(patterns) {
	const includes = [];
	const excludes = [];
	for (const p of patterns) (p.startsWith("!") ? excludes : includes).push(p);
	return {
		includes,
		excludes
	};
...
* - `dest`      = `to/file`
*/
async function includeFiles(patterns) {
	const { includes, excludes } = splitPatterns(patterns);
	const globber = await create([...includes, ...excludes].join("\n"), {
...
//#endregion
//#region src/main.ts
function createOperator(provider, options) {
	const retryLayer = new opendal_exports.RetryLayer();
	retryLayer.jitter = true;
	retryLayer.maxTimes = 4;
	return new opendal_exports.Operator(provider, options).layer(retryLayer.build());
}
async function uploadFile(op, spec, flatten) {
