...
// node_modules/@opendal/lib-darwin-arm64/opendal.darwin-arm64.node
var require_opendal_darwin_arm64 = __commonJS({
  "node_modules/@opendal/lib-darwin-arm64/opendal.darwin-arm64.node"() {
  }
});

// node_modules/@opendal/lib-darwin-arm64/package.json
var require_package = __commonJS({
  "node_modules/@opendal/lib-darwin-arm64/package.json"(exports2, module2) {
    module2.exports = {
...
// node_modules/opendal/generated.js
var require_generated = __commonJS({
  "node_modules/opendal/generated.js"(exports2, module2) {
    ...
    function requireNative() {
      if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
        ...
        if (process.arch === "x64") {
          ...
          try {
            const binding = require_opendal_darwin_arm64();
    ...
    module2.exports.BlockingLister = nativeBinding.BlockingLister;
    module2.exports.BlockingReader = nativeBinding.BlockingReader;
    module2.exports.BlockingWriter = nativeBinding.BlockingWriter;
    module2.exports.Capability = nativeBinding.Capability;
    module2.exports.ConcurrentLimitLayer = nativeBinding.ConcurrentLimitLayer;
    module2.exports.Entry = nativeBinding.Entry;
    module2.exports.Layer = nativeBinding.Layer;
    module2.exports.Lister = nativeBinding.Lister;
    module2.exports.LoggingLayer = nativeBinding.LoggingLayer;
    module2.exports.Metadata = nativeBinding.Metadata;
    module2.exports.Operator = nativeBinding.Operator;
    module2.exports.Reader = nativeBinding.Reader;
    module2.exports.RetryLayer = nativeBinding.RetryLayer;
    module2.exports.ThrottleLayer = nativeBinding.ThrottleLayer;
    module2.exports.TimeoutLayer = nativeBinding.TimeoutLayer;
    module2.exports.Writer = nativeBinding.Writer;
    module2.exports.EntryMode = nativeBinding.EntryMode;
  }
});
...
var generated = __toESM(require_generated(), 1);
__reExport(opendal_exports, __toESM(require_generated(), 1));
var ReadStream = class extends import_node_stream.Readable {
...
var BlockingReadStream = class extends import_node_stream.Readable {
  constructor(reader, options) {
    super(options);
    this.reader = reader;
  }
...
var WriteStream = class extends import_node_stream.Writable {
...
var BlockingWriteStream = class extends import_node_stream.Writable {
  constructor(writer, options) {
    super(options);
    this.writer = writer;
  }
...
var { Operator, RetryLayer, ConcurrentLimitLayer, BlockingReader, Reader, BlockingWriter, Writer } = generated;
...
var Path = class {
  ...
  toString() {
    ...
    let skipSlash = result.endsWith(path2.sep) || IS_WINDOWS5 && /^[A-Z]:$/i.test(result);
    ...
    return __asyncGenerator(this, arguments, function* globGenerator_1() {
      ...
      while (stack.length) {
        ...
        if (stats.isDirectory()) {
          ...
          const childItems = (yield __await(fs2.promises.readdir(item.path))).map((x) => new SearchState(path4.join(item.path, x), childLevel));
...
var includeFiles = async (patterns) => {
...
async function run() {
  try {
    ...
    error(`Upload files failed: ${error2}`);
